...
public class ColorBarLayer extends Layer {
    ...
    protected void fireLayerPropertyChanged(PropertyChangeEvent event) {
        ...
        if (propertyName.equals(ColorBarLayerType.PROPERTY_NAME_RES_AUTO) ||
            propertyName.equals(ColorBarLayerType.PROPERTY_NAME_RES_LAT) ||
            propertyName.equals(ColorBarLayerType.PROPERTY_NAME_RES_LON) ||
            propertyName.equals(ColorBarLayerType.PROPERTY_NAME_RES_PIXELS)) {
            graticule = null;
        }
    ...
    private boolean getResAuto() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_RES_AUTO,
                                        ColorBarLayerType.DEFAULT_RES_AUTO);
    }

    private double getResLon() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_RES_LON,
                                        ColorBarLayerType.DEFAULT_RES_LON);
    }

    private double getResLat() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_RES_LAT,
                                        ColorBarLayerType.DEFAULT_RES_LAT);
    }

    private int getResPixels() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_RES_PIXELS,
                                        ColorBarLayerType.DEFAULT_RES_PIXELS);
    }

    private boolean isTextEnabled() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_TEXT_ENABLED,
                                        ColorBarLayerType.DEFAULT_TEXT_ENABLED);
    }

    private Color getLineColor() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_LINE_COLOR,
                                        ColorBarLayerType.DEFAULT_LINE_COLOR);
    }

    private double getLineTransparency() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_LINE_TRANSPARENCY,
                                        ColorBarLayerType.DEFAULT_LINE_TRANSPARENCY);
    }

    private double getLineWidth() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_LINE_WIDTH,
                                        ColorBarLayerType.DEFAULT_LINE_WIDTH);
    }

    private Font getTextFont() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_TEXT_FONT,
                                        ColorBarLayerType.DEFAULT_TEXT_FONT);
    }

    private Color getTextFgColor() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_TEXT_FG_COLOR,
                                        ColorBarLayerType.DEFAULT_TEXT_FG_COLOR);
    }

    private Color getTextBgColor() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_TEXT_BG_COLOR,
                                        ColorBarLayerType.DEFAULT_TEXT_BG_COLOR);
    }

    private double getTextBgTransparency() {
        return getConfigurationProperty(ColorBarLayerType.PROPERTY_NAME_TEXT_BG_TRANSPARENCY,
